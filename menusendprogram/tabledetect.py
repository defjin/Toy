# 갓갓맨.....-_-. 그림에서 테이블 인식해서 joint를 찾아줌.
# https://github.com/lxj0276/tableDetect
# coding:utf-8
'''
表格生成线条坐标
'''
...
if __name__=='__main__':
    location =  r"C:\Users\student\Downloads"
    #img = cv2.imread(location +'\p27.png')
    img = cv2.imread(location +'\menuBox2.jpg')
    cv2.imshow("img",img)
